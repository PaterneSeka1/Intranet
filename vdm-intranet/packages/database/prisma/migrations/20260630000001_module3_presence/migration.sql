...
-- CreateEnum
CREATE TYPE "TabType" AS ENUM ('ARTICLE', 'LINK', 'DASHBOARD', 'REPORT', 'CUSTOM');

-- CreateEnum
CREATE TYPE "LogAction" AS ENUM ('LOGIN', 'LOGOUT', 'VIEW', 'CREATE', 'UPDATE', 'DELETE', 'EXPORT', 'GEOLOCATION');
...
CREATE TABLE "portal_tabs" (
    ...
    "title" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "type" "TabType" NOT NULL DEFAULT 'CUSTOM',
    "businessUnitId" TEXT NOT NULL,
    "content" TEXT,
    "url" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "portal_tabs_businessUnitId_slug_key" ON "portal_tabs"("businessUnitId", "slug");
